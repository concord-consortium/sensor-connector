...
pkgbuild --root ./SensorConnector.app --scripts scripts --identifier org.concord.sensorconnector.app.pkg --version 1.0.0.20150715 --install-location /Applications/SensorConnector.app SensorConnectorApp.pkg
