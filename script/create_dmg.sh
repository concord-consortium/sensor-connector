...
hdiutil create -srcfolder "dist/app" -volname "Sensor Connector Installer" -fs HFS+ -fsargs "-c c=64,a=16,e=16" -format UDRW -size 250M dist/SensorConnector.tmp.dmg
...
echo '
   tell application "Finder"
     tell disk "Sensor Connector Installer"
           ...
           set position of item "SensorConnector.pkg" of container window to {200, 100}
